...
if __name__=="__main__":
    ...
    if_train = False # True: train model False test model
    ...
    if if_train:
        ...
        model = get_seg_model("/opt/ml/input/pretrained/hrnet_best_model(pretrained)_light_5_miou.pt", use_pretrain=True)
        model = model.cuda()
        ...
        train(num_epochs, model, train_loader, val_loader, criterion, optimizer, saved_dir, val_every)
        ...
        save_sub(file_names, preds, "/opt/ml/code/submission/hrnet_best_miou_epoch_5.csv")