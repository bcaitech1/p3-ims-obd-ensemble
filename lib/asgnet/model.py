...
import lib.asgnet.resnet as models
from lib.asgnet.module.decoder import build_decoder
from lib.asgnet.module.ASPP import ASPP
...
class ASGNet(nn.Module):
    def __init__(self, layers = 50, classes = 2):
...
########################### Context Module ###########################
    ...
    def _optimizer(self, lr, momentum, weight_decay):
        if self.pyramid:
