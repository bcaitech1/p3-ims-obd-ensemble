...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.ocr_gather_head = SpatialGather_Module(12)
        ...
        self.cls_head = nn.Conv2d(
            ocr_mid_channels, 12, kernel_size=1, stride=1, padding=0, bias=True)
        ...
        self.aux_head = nn.Sequential(
            ...
            nn.ReLU(inplace=relu_inplace),
            nn.Conv2d(last_inp_channels, 12,
        ...
        for i in range(num_branches_cur):
            if i < num_branches_pre:
                ...
                for j in range(i+1-num_branches_pre):
                    ...
                    conv3x3s.append(nn.Sequential(
                        nn.Conv2d(
                            inchannels, outchannels, 3, 1, 1, bias=False),
...
def get_seg_model(pretrain_path, use_pretrain = False):
